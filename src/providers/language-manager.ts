...
export class LanguageManager {
    ...
    translations = {
        "ua": {
            ...
            "no_config_first_time_loading": "Додаток містить лише демонстраційні файли. Для завантаження повного пакету файлів натисніть Ок. Завантажити файли можна також в меню 'Завантажити оновлення'.",
            "attention": "Увага",
        ...
        "ru": {
            ...
            "no_config_first_time_loading": "Приложение содержит только демонстрационные файлы. Для загрузки полного пакета файлов нажмите Ок. Скачать файлы можно также в меню 'Скачать обновление'.",
            "attention": "Внимание",
